...
export default function Checkout() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-3 sm:px-4 py-8">
      <h1 className="text-2xl font-bold text-indigo-900 mb-6">Checkout</h1>

      <div className="bg-white rounded-xl shadow p-4 mb-4">
        <h2 className="font-bold text-sm text-gray-700 mb-3">Your Items ({cart.length})</h2>
      ...
      {!isMultiSeller && sellerLocations.location_1 && (
        <div className="bg-blue-50 border border-blue-300 rounded-xl p-4 mb-4 text-sm">
          <p className="font-bold text-blue-800 mb-2">📍 Choose Your Delivery Point</p>
      ...
      <div className="bg-white rounded-xl shadow p-4 mb-4">
        <h2 className="font-bold text-sm text-gray-700 mb-3">Contact Details</h2>
        <div className="space-y-3">
          <div>
            <label className="block text-xs font-semibold text-gray-600 mb-1">Phone Number (MoMo / Contact)</label>
            <input
              type="tel"
              value={phone}
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-600 mb-1">Additional Info (optional)</label>
            <textarea
              rows={2}
              value={address}
        ...
        {paymentMethod === 'pay_on_delivery' && (
          <div className="mt-4 bg-gray-50 rounded-lg p-3 text-xs">
            ...
            <button
              type="button"
              onClick={copyNumber}
              className="mt-2 bg-indigo-100 hover:bg-indigo-200 text-indigo-700 font-semibold px-3 py-1 rounded text-xs"
            >
      ...
      {paymentMethod === 'pay_on_delivery' && (
        <button
          ...
          disabled={loading}
          className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-3 rounded-lg text-sm disabled:opacity-60"
        >
